...
// Function to trigger the cart drawer
...
function openCartDrawer() {
  const cartDrawer = document.querySelector(".tt-sliding-cart-wrap");
  cartDrawer.classList.add("open"); // Assuming you have a CSS class that shows the drawer
}
...
function openCartDrawer() {
  const cartWrap = document.querySelector(".tt-sliding-cart-wrap");
  cartWrap.classList.remove("hide"); // Ensure the cart is visible (adjust the class as needed)
}
